...
class TestMetadata(unittest.TestCase):
    ...
    def test_metadata_add_processing_step(self):
        ...
        metadata = Metadata(
            data_type=DataType.IMAGE, processing_stage=ProcessingStage.SOURCE
        )
        ...
        self.assertEqual(
            metadata.processing_times[ProcessingStage.PREPROCESSING.value], 0.1
        )
...
class TestDataContainer(unittest.TestCase):
    ...
    def test_data_container_update_stage(self):
        ...
        self.assertEqual(
            container.metadata.processing_stage, ProcessingStage.PREPROCESSING
        )
...
class TestPipelineConfig(unittest.TestCase):
    ...
    def test_pipeline_config_creation(self):
        ...
        config = PipelineConfig(
            batch_size=4, enable_profiling=True, continue_on_error=False
        )
...
class TestInferenceAdapter(unittest.TestCase):
    ...
    def test_inference_adapter_process(self):
        ...
        input_metadata = Metadata(
            data_type=DataType.TENSOR, processing_stage=ProcessingStage.PREPROCESSING
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def test_simple_pipeline_integration(self, mock_preprocessor_class):
        ...
        preprocessor = PreprocessorAdapter(
            PreprocessConfig(target_width=640, target_height=640)
        )
        inference = InferenceAdapter(
            mock_engine, {"name": "TestModel", "version": "1.0", "task": "detection"}
        )
