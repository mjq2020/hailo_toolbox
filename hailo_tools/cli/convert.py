...
def parse_args() -> argparse.Namespace:
    ...
    Returns:
        Parsed arguments.
    """
    parser = argparse.ArgumentParser(description="Convert deep learning models to ONNX format")
    ...
    parser.add_argument(
        "--dynamic-axes",
        type=str,
        help="Dynamic axes configuration (JSON string)"
    )
